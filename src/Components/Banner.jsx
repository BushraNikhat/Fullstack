                    ...
                    <div className="container-fluid" >
                            <div className="row">
                                <div className="col-10 mx-auto d-block d-flex flex-column justify-content-center header-content-box">
                                       ...
                                       <h3 className="small-heading">full stack developer .</h3>
                                       <p className="text-white">A web development enthusiast, having all the key skill that makes me full stack developer.</p>
