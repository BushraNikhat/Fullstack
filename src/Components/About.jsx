            ...
            <div className="col-10 mx-auto d-block">
              ...
              <div className="row">
                ...
                <h1 className="large-heading text-center about-head">
                 ...
                 Innovative full stack developer passionate about building and maintaining responsive websites, keeping user experience in mind. Like to develop end to end web applications and websites.
                  </p>
                  </div>
                  ...
                  <button className="btn  button mx-auto d-block"><a href="https://drive.google.com/uc?export=download&id=1L5775F5cBwAlI3jK0gezWiNYoF_E5DVW" className="">Download CV</a></button>
                </div>
              </div>
            </div>
          </div>
